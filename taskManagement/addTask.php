                                            ...
                                            <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="text-input" name="name" placeholder="Enter Task Name" class="form-control">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        ...
                                                        <input type="text" id="text-input" name="skills" placeholder="enter skills" class="form-control">
