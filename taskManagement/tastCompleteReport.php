            ...
            <div class="main-content" style="background-color: white;">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="text-center">Completed Task Report</h3>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    while ($row2 = mysqli_fetch_array($selectTask)) {
                                                        ...
                                                        $count++;
                                                        $selectDeveloper = mysqli_query($connect, "SELECT email,names,tel FROM users WHERE id='$row2[1]' ");
                                ...
                                <br><br>
                                <center><a href="tastCompleteReportPrint.php" target="blank" class="btn btn-primary">Print</a></center>
                            </div>
                        </div>
                    </div>
                </div>
